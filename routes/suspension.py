...
bp = Blueprint('suspension', __name__)
...
@bp.route('/generate-suspension', methods=['POST'])
def generate_suspension():
    ...
    word_path = f"{GENERATED_LETTERS_PATH}/suspension_{roll_no}_{unique_id}.docx"
    pdf_path = word_path.replace('.docx', '.pdf')

    doc = Document('templates/Suspension.docx')
    ...
    return jsonify({
        'message': 'Suspension letter generated successfully!',
        'download_link': f'http://localhost:5001/download/suspension_{roll_no}_{unique_id}.pdf'
    })